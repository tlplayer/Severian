...
fn replacement_ops(op: BinaryOp) -> Vec<BinaryOp> {
    match op {
        ...
        BinaryOp::BitOr => vec![BinaryOp::BitXor, BinaryOp::BitAnd],
        BinaryOp::BitXor => vec![BinaryOp::BitOr, BinaryOp::BitAnd],
        BinaryOp::BitAnd => vec![BinaryOp::BitOr, BinaryOp::BitXor],
