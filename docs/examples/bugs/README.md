...
| Threads | `dangling_thread_reference` | compile-time / scheduler-level |
| Async | `forgotten_await` | compile-time |
| Async | `task_outlives_scope` | compile-time / scheduler-level |
