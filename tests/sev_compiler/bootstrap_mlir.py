...
def main():
    ...
    inputs.update({
        ...
        "example_math": (ROOT / "tests/sev_compiler/fixtures/building/math.sev", "build"),
        "example_building_library": (ROOT / "tests/sev_compiler/fixtures/building/lib.sev", "build"),
        "example_building_library_tests": (ROOT / "tests/sev_compiler/fixtures/building/lib.sev", "test"),
        "example_building_binary": (ROOT / "tests/sev_compiler/fixtures/building/main.sev", "build"),
        "example_building_binary_tests": (ROOT / "tests/sev_compiler/fixtures/building/main.sev", "test"),
    ...
    rejected = {
        ...
        "wrong_condition": ("def answer() -> i32:\n    if 1:\n        return 1\n    return 0\n", "condition requires a truth protocol returning bool"),
        ...
        "immutable_update": ('def main():\n    value = "a"\n    value += "b"\n', "cannot reassign immutable"),
        "unknown_update": ("def main():\n    value += 1\n", "unknown name value"),
